...
////							+ "            <p>Để đảm bảo thời gian giao hàng và nâng cao trải nghiệm khách hàng, vui lòng xử lý đơn hàng này trong vòng <strong>2 giờ tới, trong vòng 2 giờ tới đơn hàng của quý khách vẫn chưa duyệt chúng tôi sẽ duyệt tự động để đảm bảo trải nghiệm của khách hàng.</strong>.</p>\r\n"
