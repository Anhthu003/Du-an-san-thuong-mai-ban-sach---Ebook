		...
		<div class="container">
			...
			<div class="page-content rounded-2">
				<div class="row">
					...
					<div class="col-md-6">
						<h6 class="xemThem" style="cursor: pointer;">
							<a href="/user/fillist/hot">Xem Thêm</a>
						</h6>
					</div>
				</div>
										...
										<div class="card">
											...
											<div class="card-body">
												...
												<h5 class="card-text textOranger" style="color: red">
													<span
														style="text-decoration: line-through; color: rgba(0, 0, 0, 0.463)">
														<fmt:formatNumber>${item.price}</fmt:formatNumber> <sup>đ</sup>
													</span>
													<fmt:formatNumber>${item.price-item.discount}
																</fmt:formatNumber>
													<sup>đ</sup>
												</h5>
												...
												<div class="star">
													...
													</span> <span class="d-inline-block ml-2">Đã bán <fmt:formatNumber>${item.quantitySell}
																	</fmt:formatNumber>
													</span>
												</div>
												...
												<div class="row">
													...
													<%
													// Lấy HttpServletRequest từ PageContext
													HttpServletRequest req = (HttpServletRequest) pageContext.getRequest();

													// Lấy đường dẫn hiện tại
													String currentUrl = req.getServletContext().getContextPath().toString();
													...
													// Tạo đường dẫn mới
													String newUrl = req.getContextPath() + "/us/newPage";
													%>
													<c:set var="url" value="<%=currentUrl%>" />
													<div class="col-md-6 ">
														<a href="/user/${url}"> <i class="bi bi-heart-fill heard"></i>
														</a>
													</div>
													...
													<%-- 				<c:if test="${listLike.size()>0}">
														...
														<c:if test="${stop==true}">
															<a href="/user/favorite/${item.id}&url=${pageContext.request.contextPath}">
																<div class="col-md-6 ">
														...
														<c:if test="${stop==false}">
															<div class="col-md-6 " style="font-size: 1.8rem">
																<a
																	href="/user/favorite/${item.id}&url=${pageContext.request.contextPath}">
			...
			<div class="page-content rounded-2">
				<div class="row">
					...
					<div class="col-md-6">
						<h6 class="xemThem" style="cursor: pointer;">
							<a href="/user/fillist/new">Xem Thêm</a>
						</h6>
					</div>
				</div>
				<div class="slider-container">
							...
							<div class="card SP cardMoi">
								...
								<div class="card-body">
									...
									<div class="star">
										...
										</span> <span class="d-inline-block ml-2">Đã bán <fmt:formatNumber>
															${item.quantitySell}</fmt:formatNumber>
										</span>
									</div>
									<div class="row">
										<a class="col-md-6 btn btn-outline-danger"
