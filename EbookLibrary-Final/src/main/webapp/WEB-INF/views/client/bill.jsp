						...
						<div class="card">
							<div>
								<p class="noiDungPhai">
									<c:choose>
										<c:when
											test="${bill.orderStatus.id == 5 && bill.status == false}">
							...
							<c:forEach var="entry" items="${shopProductsMap.entrySet()}">
								<div class="card-header thongtin-nguoiban" >
									<div class="anh-nguoiban">
								...
								<c:forEach var="billDetail" items="${entry.value}">
										...
										<div class="list-book">
											<div class="book">
												...
												<div class="book-content">
													<a href="/user/xemsanpham/${billDetail.product.id}"
									...
									<c:if
										test="${bill.orderStatus.id == 1 && bill.status == false}">
										<div class="hoanthanh">
											<form action="/user/mualai/${billDetail.product.id}"
												method="post">
												<button type="submit" class="btn btn-success btn-mualai">Mua
							...
							<div class="card-footer">
								<div class="chucNang">
									<div class="button-edit">
										<c:choose>
											<c:when
												test="${bill.orderStatus.id == 1 && bill.status == true}">
												<button type="button"
